...
from model_dual_mLSTM import get_multi_gpu_models
...
try:
    ...
    slack = None
header= "quora_dual_mLSTM" # description for this training. 
...
flags.DEFINE_integer("batch_size", 150, "Batch size [600]") # 100 . not 200
